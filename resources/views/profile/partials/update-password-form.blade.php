<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Quitte à changer de mot de passe, profites-en pour en mettre un sécurisé ;)') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confimation du nouveau mot de passe')" />
